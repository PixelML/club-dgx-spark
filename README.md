...
verification versus GDN backends) that applies to every Mamba-class hybrid.
Sanitized receipts:
[results/2026-09-09-qwen3.8-flash-next-dflash-drafter-2node-tp2-vllm/](results/2026-09-09-qwen3.8-flash-next-dflash-drafter-2node-tp2-vllm/README.md).
